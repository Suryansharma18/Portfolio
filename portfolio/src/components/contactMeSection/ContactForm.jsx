...
const ContactForm = () => {
  ...
  return (
    <div>
      <h4 className="text-cyan">{success}</h4>
      <form className='flex flex-col gap-4 text-white' ref={form} onSubmit={sendEmail}>
        ...
        <textarea name='message' type="text" placeholder='Message' rows="9" cols="50" required className=" rounded-lg bg-lightBrown p-2" value={message} onChange={handleMessage}></textarea>
